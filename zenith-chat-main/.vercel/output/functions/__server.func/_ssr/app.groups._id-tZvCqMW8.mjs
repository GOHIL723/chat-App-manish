...
import { b as Route$1, a as useSocket, u as useAuth } from "./router-B-OB1NeJ.mjs";
...
import { a5 as ChevronLeft, U as Users, h as Settings, X, a6 as Smile, a7 as Paperclip, a8 as Image, a9 as CircleAlert, aa as CircleStop, W as Mic, ab as Send, z as Sparkles, L as LoaderCircle, j as LogOut, ac as Reply, ad as Forward, ae as UserPlus, C as Crown } from "../_libs/lucide-react.mjs";
...
function GroupChatRoom() {
  ...
  const uploadAndSend = reactExports.useCallback(async (file, type, duration) => {
    setIsUploading(true);
    try {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 flex flex-col min-w-0 relative", onDragEnter: (e) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "h-16 px-4 flex items-center justify-between glass border-b border-border/50 z-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/app/groups", className: "md:hidden h-10 w-10 rounded-xl text-muted-foreground hover:bg-accent hover:text-foreground flex items-center justify-center shrink-0 mr-1", title: "Back to groups", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronLeft, { className: "h-6 w-6" }) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col min-w-0", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 md:p-5 pb-4 md:pb-5 relative", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-strong rounded-2xl p-2 flex items-end gap-2 z-10 relative", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => imageInputRef.current?.click(), className: "h-10 w-10 rounded-xl text-muted-foreground hover:bg-accent flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Image, { className: "h-4 w-4" }) }),
