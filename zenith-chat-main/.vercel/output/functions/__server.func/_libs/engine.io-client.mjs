import { X as XMLHttpRequest$2, a as XMLHttpRequestModule } from "./xmlhttprequest-ssl.mjs";
import { d as decodePacket, a as decodePayload, e as encodePayload, b as encodePacket, c as createPacketDecoderStream, f as createPacketEncoderStream, p as protocol } from "./engine.io-parser.mjs";
import { E as Emitter } from "./socket.io__component-emitter.mjs";
import { d as debugModule } from "./debug.mjs";
...
const debug$5 = debugModule("engine.io-client:transport");
...
const debug$4 = debugModule("engine.io-client:polling");
...
const hasCORS = value;
const debug$3 = debugModule("engine.io-client:polling");
function empty() {
}
...
const debug$2 = debugModule("engine.io-client:websocket");
...
const debug$1 = debugModule("engine.io-client:webtransport");
      ...
      this._transport.createBidirectionalStream().then((stream) => {
        ...
        const read = () => {
          reader.read().then(({ done, value: value2 }) => {
            ...
            debug$1("received chunk: %o", value2);
...
const debug = debugModule("engine.io-client:socket");
